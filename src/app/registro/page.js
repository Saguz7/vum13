  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      if (personaType === 'fisica') {
        ...
        isFormComplete =
          /^[A-Za-z]{4}[0-9]{6}[A-Za-z0-9]{8}$/.test(formData.curp) &&
          /^[A-Za-z]{4}[0-9]{6}[A-Za-z0-9]{3}$/.test(formData.rfc) &&
          /^[A-Za-z\s]*$/.test(formData.nombre) &&
          /^[A-Za-z\s]*$/.test(formData.primer_apellido) &&
          ...
          <div className="card margin-top-3">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center mt-4">
              <div className="d-flex justify-content-center w-100 form-select-type">
                ...
                <div className="col-sm-12 col-md-6 my-2 text-center">
                    <input
                      data-testid="radio-fisica"
                      type="radio"
                      id="radio2"
                      name="personaType"
                      value="fisica"
                      ...
                      <div className="col-12">
                        ...
                        <div className="row">
                          <div className="col-sm-12 col-md-6">
                            <div className="col-12">
                              <label >CURP (*)</label> 
                              {errors.curp && <p className="error-message">Error</p>}

                            </div>
                            <div className="col-12">
                              <Input id="curpInput" value={formData.curp} onChange={(value) => handleInputChange('curp', value)}/> 
                          ...
                          <div className="col-12">
                            <label >RFC (*)</label>
                            {errors.rfc && <p className="error-message">Error</p>}

                            </div>
                            <div className="col-12">
                            <Input id="rfcInput" value={formData.rfc} onChange={(value) => handleInputChange('rfc', value)}/>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12">
                            ...
                            <div className="col-12">
                            <Input id="nombreInput" value={formData.nombre} onChange={(value) => handleInputChange('nombre', value)}/>
                          ...
                          <div className="col-12">
                            ...
                            <div className="col-12">
                            <Input id="primer_apellidoInput" value={formData.primer_apellido} onChange={(value) => handleInputChange('primer_apellido', value)}/>
                          ...
                          <div className="col-12">
                            ...
                            <div className="col-12">
                            <Input id="segundo_apellidoInput" value={formData.segundo_apellido} onChange={(value) => handleInputChange('segundo_apellido', value)}/>
                        ...
                        <div className="row">
                          ...
                          <div className="col-sm-12 col-md-6">
                            ...
                            <div className="col-12">
                              <Input id="confirmacion_correoInput"
                                value={formData.confirmacion_correo}
                                onChange={(value) => handleInputChange('confirmacion_correo', value)}
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="row">
                          <div className="col-sm-12 col-md-6">
                            <div className="col-12">
                              ...
                              <div className="col-12">
                              <Input id="telefono_celularInput" value={formData.telefono_celular} onChange={(value) => handleInputChange('telefono_celular', value)}/>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <div className="col-12">
                              ...
                              <div className="col-12">
                              <Input id="telefono_residencialInput" value={formData.telefono_residencial} onChange={(value) => handleInputChange('telefono_residencial', value)}/>
                        ...
                        <div className="row">
                          <div className="col-sm-12 col-md-6">
                            <div className="col-12">
                              ...
                              <div className="col-12">
                              <Input id="clave_accesoInput" type="password"  value={formData.clave_acceso} onChange={(value) => handleInputChange('clave_acceso', value)}/>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <div className="col-12">
                              ...
                              <div className="col-12">
                              <Input id="clave_acceso_repetidaInput" type="password" value={formData.clave_acceso_repetida} onChange={(value) => handleInputChange('clave_acceso_repetida', value)}/>
