...
const SteppedProgressBar = () => {
  const stepsArray = ["Documentación", "Datos Hospedaje" ];
                      ...
                      <div className="row margin-top-messages-error">
                        <div className="col-12">
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-12 col-md-4">
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.modalidad}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("modalidad", value)
                                  }
                                  error={
                                    errorsRegistro.modalidad
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Habitaciones (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.habitaciones}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("habitaciones", value)
                                  }
                                  error={
                                    errorsRegistro.habitaciones
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-12 col-md-6">
                              <div className="col-12">
                                <label className="label-form">Fecha de obligaciones (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.fecha_obligacion}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("fecha_obligacion", value)
                                  }
                                  error={
                                    errorsRegistro.fecha_obligacion
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
