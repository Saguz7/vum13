...
const SteppedProgressBar = () => {
  const stepsArray = ["Documentación", "Datos Nomina" ];
  ...
  const [errorsRegistro, setErrorsRegistro] = useState({ 
    ...
    fecha_presentacion: false,
    actividad_economica: false,
    establecimiento: false,
    fecha_inicio_operaciones: false,
    sector: false, 
    empleados: false,
    periocidad: false,
    fecha_baja: false,
    fecha_reanudacion: false,
    comentarios: false 
                        ...
                        <div className="col-12">
                          ...
                          <div className="row">
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Cuenta (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.cuenta}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("cuenta", value)
                                  }
                                  error={
                                    errorsRegistro.cuenta
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Oficina (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.oficina}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("oficina", value)
                                  }
                                  error={
                                    errorsRegistro.oficina
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Estatus (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.estatus}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("estatus", value)
                                  }
                                  error={
                                    errorsRegistro.estatus
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                          ...
                          <div className="row">
                            <div className="col-sm-12 col-md-4">
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.nombre_comercial}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("nombre_comercial", value)
                                  }
                                  error={
                                    errorsRegistro.nombre_comercial
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Fecha de presentación (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.fecha_presentacion}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("fecha_presentacion", value)
                                  }
                                  error={
                                    errorsRegistro.fecha_presentacion
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Actividad Económica (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.actividad_economica}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("actividad_economica", value)
                                  }
                                  error={
                                    errorsRegistro.actividad_economica
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                          ...
                          <div className="row">
                            <div className="col-sm-12 col-md-8">
                              <div className="col-12">
                                <label className="label-form">Establecimiento (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.establecimiento}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("establecimiento", value)
                                  }
                                  error={
                                    errorsRegistro.establecimiento
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Fecha inicio de operaciones (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.fecha_inicio_operaciones}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("fecha_inicio_operaciones", value)
                                  }
                                  error={
                                    errorsRegistro.fecha_inicio_operaciones
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                          ...
                          <div className="col-sm-12 col-md-4">
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.sector}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("sector", value)
                                  }
                                  error={
                                    errorsRegistro.sector
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Empleados (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="curpInput"
                                  value={formDataRegistro.empleados}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("empleados", value)
                                  }
                                  error={
                                    errorsRegistro.empleados
                                      ? "Por favor, ingrese un CURP válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Periocidad (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.periocidad}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("periocidad", value)
                                  }
                                  error={
                                    errorsRegistro.periocidad
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Fecha de Baja (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  ...
                                  onChange={(value) =>
                                    handleInputChangeRegistro("fecha_baja", value)
                                  }
                                  error={
                            ...
                            <div className="col-sm-12 col-md-4">
                              <div className="col-12">
                                <label className="label-form">Fecha de Reanudación (*)</label>
                                <FontAwesomeIcon
                                  icon={faQuestionCircle}
                                  style={{
                                    marginLeft: "5px",
                              ...
                              <div className="col-12">
                                <Input
                                  id="rfcInput"
                                  value={formDataRegistro.fecha_reanudacion}
                                  onChange={(value) =>
                                    handleInputChangeRegistro("fecha_reanudacion", value)
                                  }
                                  error={
                                    errorsRegistro.fecha_reanudacion
                                      ? "Por favor, ingrese un RFC válido."
                                      : ""
                                  }
                                />
